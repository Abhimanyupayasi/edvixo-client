    ...
    >
      <div className="mx-auto flex h-20 max-w-355 items-center justify-between px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <span className="ml-3 text-3xl font-black tracking-tight text-white">EDVIXO</span>
        </Link>
        ...
        >
          {navMenus.map((menu) => (
            ...
            >
              ...
              <div
                className="pointer-events-none absolute left-1/2 top-full z-50 mt-3 w-[min(1180px,74vw)] -translate-x-1/2 translate-y-3 opacity-0 invisible transition-all duration-250 ease-out group-hover:pointer-events-auto group-hover:visible group-hover:translate-y-0 group-hover:opacity-100"
                aria-hidden={!isActiveLink(menu.href) && true}
              >
                <div className="overflow-hidden rounded-xl border border-white/10 bg-[#f4f5f3] text-[#111827] shadow-[0_18px_42px_rgba(15,23,42,0.28)]">
                          ...
                          <div className="space-y-1.5">
                            {column.items.map((item) => (
                              <Link
                                ...
                                href={item.href}
                                className="block rounded-md px-2 py-2 text-base font-medium text-slate-700 transition-all duration-200 hover:bg-[#edf3ee] hover:text-[#0f172a]"
                              >
                    ...
                    <div className="grid gap-5 p-6 sm:grid-cols-2 lg:grid-cols-3">
                      {menu.items?.map((item) => (
                        <Link
                          ...
                          href={item.href}
                          className="group/item rounded-lg px-3 py-2 text-base font-medium text-slate-700 transition-all duration-200 hover:bg-[#edf3ee] hover:text-[#0f172a]"
                        >
